...
const UI = {
  it: {
    ...
    tagline: "Ritmo lento · niente sveglie all'alba",
    ...
    langName: "Italiano",
    photoHint: "Aggiungere le proprie foto in img/ (day1.jpg … day10.jpg) per personalizzare le copertine.",
    backHome: "Tutti i giorni",
    prevDay: "Precedente", nextDay: "Successivo",
    offline: "Il sito funziona anche offline dopo la prima visita.",
  },
  en: {
    appTitle: "Bali · 20–29 July 2026",
    tagline: "Slow pace · no early alarms",
    ...
    langName: "English",
    photoHint: "Add personal photos to img/ (day1.jpg … day10.jpg) to customise the covers.",
    backHome: "All days",
    prevDay: "Previous", nextDay: "Next",
    offline: "The site also works offline after the first visit.",
  },
  zh: {
    ...
    langName: "简体中文",
    photoHint: "将个人照片放入 img/ 文件夹（day1.jpg … day10.jpg）即可自定义封面。",
    backHome: "全部行程",
    prevDay: "上一天", nextDay: "下一天",
    offline: "首次访问后，网站可离线使用。",
  }
};
...
// ---------------------------------------------------------- DAY 10
{
  ...
  timeline: [
    ...
    { t: "16:25", icon: "✈️", title: { it: "Decollo MH850 → Kuala Lumpur", en: "MH850 take-off → Kuala Lumpur", zh: "MH850起飞 → 吉隆坡" },
      desc: { it: "Poi MH522 per Shenzhen alle 21:05 (scalo ~2h05, comodo). Bagaglio di norma imbarcato fino a destinazione: confermarlo al check-in.", en: "Then MH522 to Shenzhen at 21:05 (layover ~2h05, comfortable). Luggage normally checked through to destination: confirm at check-in.", zh: "随后21:05乘MH522飞深圳（中转约2小时05分，从容）。行李通常直挂目的地：值机时确认。" } },
  ],
  notes: {
