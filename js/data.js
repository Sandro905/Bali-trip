...
const UI = {
  it: {
    ...
    timeline: "La giornata", notes: "Note", transport: "Trasporti del giorno",
    mapTitle: "La mappa del viaggio", mapOpen: "Aprire in Google Maps",
    flightStatus: "Stato volo in tempo reale", menu: "Menù",
  ...
  en: {
    ...
    timeline: "The day", notes: "Notes", transport: "Transport for the day",
    mapTitle: "The trip map", mapOpen: "Open in Google Maps",
    flightStatus: "Live flight status", menu: "Menu",
  ...
  zh: {
    ...
    download: "下载完整行程 (.md)",
    timeline: "当日安排", notes: "备注", transport: "当日交通",
    mapTitle: "行程地图", mapOpen: "在Google Maps中打开",
    flightStatus: "实时航班状态", menu: "菜单",
...
// Named map link: [displayName, mapsUrl]. Query defaults to the name.
const P = (name, q) => [name, gm(q || name)];
...
// ---------------------------------------------------------- DAY 1
{
  ...
  groups: { fly: { it: "✈️ Shenzhen → Bali · MH523 + MH715", en: "✈️ Shenzhen → Bali · MH523 + MH715", zh: "✈️ 深圳 → 巴厘岛 · MH523 + MH715" } },
  timeline: [
    { t: "00:00", icon: "🛫", grp: "fly", title: { it: "Aeroporto di Shenzhen (SZX · T3)", en: "Shenzhen Airport (SZX · T3)", zh: "深圳宝安机场 (SZX · T3)" },
    ...
    { t: "02:45", icon: "✈️", grp: "fly", title: { it: "Volo MH523 · Shenzhen → Kuala Lumpur", en: "Flight MH523 · Shenzhen → Kuala Lumpur", zh: "航班 MH523 · 深圳 → 吉隆坡" },
    ...
    { t: "06:45", icon: "🔄", grp: "fly", title: { it: "Scalo a Kuala Lumpur (KUL · T1)", en: "Layover in Kuala Lumpur (KUL · T1)", zh: "吉隆坡转机 (KUL · T1)" },
    ...
    { t: "09:00", icon: "✈️", grp: "fly", title: { it: "Volo MH715 · Kuala Lumpur → Bali", en: "Flight MH715 · Kuala Lumpur → Bali", zh: "航班 MH715 · 吉隆坡 → 巴厘岛" },
    ...
    { t: "11:47", icon: "🛬", grp: "fly", title: { it: "Atterraggio a Bali (DPS)", en: "Landing in Bali (DPS)", zh: "抵达巴厘岛 (DPS)" },
      desc: { it: "Terminal Internazionale. Attivare subito la eSIM: serve per Grab e per il delivery del pranzo.", en: "International Terminal. Activate the eSIM right away: needed for Grab and lunch delivery.", zh: "国际航站楼。立即激活eSIM：Grab打车和外卖都需要它。" }, places: [P("Aeroporto DPS", "Ngurah Rai International Airport Bali")] },
    ...
    { t: "14:00", icon: "🏡", title: { it: "Check-in, doccia, piscina", en: "Check-in, shower, pool", zh: "入住、洗漱、泳池" },
      desc: { it: "Niente fretta: recupero dal volo.", en: "No rush: flight recovery.", zh: "不必着急：好好休整。" }, places: [P("Dewani Villa Resort", "Dewani Villa Resort Bali")] },
    { t: "14:30", icon: "🍛", title: { it: "Pranzo facile", en: "Easy lunch", zh: "轻松午餐" },
      desc: { it: "Delivery in villa (GoFood/GrabFood, ~30 min) oppure Warung Nads: nasi campur, 4 min in taxi.", en: "Delivery at the villa (GoFood/GrabFood, ~30 min) or Warung Nads: nasi campur, 4 min by taxi.", zh: "别墅外卖（GoFood/GrabFood，约30分钟）或Warung Nads：杂拌饭，打车4分钟。" }, places: [P("Warung Nads", "Warung Nads Kerobokan Bali")] },
...
// ---------------------------------------------------------- DAY 2
{
  ...
  timeline: [
    ...
    { t: "12:00", icon: "🧳", title: { it: "Arrivo alla Sakara", en: "Arrival at Sakara", zh: "抵达Sakara别墅" },
      desc: { it: "Check-in se la camera è pronta, altrimenti deposito bagagli alla reception (prassi normale).", en: "Check-in if the room is ready, otherwise luggage storage at reception (standard practice).", zh: "若房间已备好则办理入住，否则先寄存行李（常规操作）。" }, places: [P("The Sakara Ubud Villas")] },
    { t: "12:30", icon: "🍽️", title: { it: "Pranzo · NEUN at Bali Nguni", en: "Lunch · NEUN at Bali Nguni", zh: "午餐 · NEUN at Bali Nguni" },
      desc: { it: "A 3 min dalla villa, in mezzo alle risaie, con piscina e gazebo.", en: "3 min from the villa, set in rice fields, with pool and gazebos.", zh: "距别墅3分钟，坐落于稻田中，设有泳池和凉亭。" }, places: [P("NEUN at Bali Nguni", "NEUN at Bali Nguni Ubud")] },
    ...
    { t: "16:00", icon: "🚶", title: { it: "Campuhan Ridge Walk", en: "Campuhan Ridge Walk", zh: "坎普罕山脊步道" },
      desc: { it: "Passeggiata facile sul crinale, 1h–1h30 a/r, splendida e fresca all'ora dorata. A 15–20 min dalla villa.", en: "Easy ridge walk, 1h–1h30 return, gorgeous and cool at golden hour. 15–20 min from the villa.", zh: "轻松的山脊步道，往返1–1.5小时，黄金时刻风景绝美且凉爽。距别墅15–20分钟。" }, places: [P("Campuhan Ridge Walk", "Campuhan Ridge Walk Ubud")] },
    { t: "18:00", icon: "🍷", title: { it: "Cena · Amsterdam Restaurant", en: "Dinner · Amsterdam Restaurant", zh: "晚餐 · Amsterdam Restaurant" },
      desc: { it: "Ubud centro: formula \"scegli 3/5 piattini\". Poi rientro in villa e relax.", en: "Ubud centre: \"pick 3/5 small plates\" formula. Then back to the villa.", zh: "乌布市中心：可自选3或5道小食拼盘。之后返回别墅休息。" }, places: [P("Amsterdam Restaurant", "Amsterdam Restaurant Ubud")] },
  ],
  notes: {
...
// ---------------------------------------------------------- DAY 4
{
  ...
  intro: {
    it: "Barca privata prenotata (Lagonara, 12:00): baia protetta, tragitto in barca di 5 minuti, adatto in caso di mal di mare. Bagagli al sicuro in villa: oggi non si cambia alloggio.",
    en: "Private boat booked (Lagonara, 12:00): sheltered bay, 5-minute boat ride, suitable with seasickness. Luggage safe at the villa: no hotel change today.",
    zh: "已预订私人船只（Lagonara，12:00）：海湾避风，乘船仅5分钟，适合晕船者。行李安全留在别墅：今天不换住宿。"
  },
  timeline: [
    ...
    { t: "15:00", icon: "🚗", title: { it: "Rientro alla Nau (~1h30)", en: "Back to Nau (~1h30)", zh: "返回Nau (~1.5小时)" },
      desc: { it: "Opzionale, quasi sulla strada: sosta a Goa Gajah, la grotta storica con la faccia scolpita (~45 min).", en: "Optional, almost on the way: stop at Goa Gajah, the historic carved-face cave (~45 min).", zh: "可选顺路一站：象窟Goa Gajah，入口为雕刻面孔的古迹洞穴（约45分钟）。" }, places: [P("Goa Gajah", "Goa Gajah Ubud")] },
    { t: "19:00", icon: "🍷", title: { it: "Cena vicino alla villa", en: "Dinner near the villa", zh: "别墅附近晚餐" },
      desc: { it: "Mimpi Manis / Yamuna / Warung D'Uma Sari.", en: "Mimpi Manis / Yamuna / Warung D'Uma Sari.", zh: "Mimpi Manis / Yamuna / Warung D'Uma Sari。" }, places: [P("Mimpi Manis", "Mimpi Manis Restaurant Tegallalang"), P("Yamuna by Dewi Kunti", "Yamuna by Dewi Kunti Villa Tegallalang"), P("Warung D'Uma Sari", "Warung D Uma Sari Tegallalang")] },
  ],
  planB: {
  ...
  notes: {
    it: ["Autista tutto il giorno: IDR 800–900k (≈ €48–53)."],
    en: ["Driver all day: IDR 800–900k (≈ €48–53)."],
    zh: ["全天包车：80–90万印尼盾（约€48–53）。"]
  },
  transport: {
...
// ---------------------------------------------------------- DAY 8
{
  ...
  timeline: [
    ...
    { t: "11:00", icon: "🚗", title: { it: "Transfer al Bombora (~25 min)", en: "Transfer to Bombora (~25 min)", zh: "前往Bombora (~25分钟)" },
      desc: { it: "Check-in, o deposito bagagli se la camera non è pronta.", en: "Check-in, or luggage storage if the room isn't ready.", zh: "办理入住，房间未备好则先寄存行李。" }, places: [P("Bombora Balangan Resort")] },
    ...
    { t: "14:45", icon: "🕳️", title: { it: "Suluban Beach / Blue Point (~40 min di strada)", en: "Suluban Beach / Blue Point (~40 min drive)", zh: "苏鲁班海滩 / Blue Point (~40分钟车程)" },
      desc: { it: "Scalinata di ~100 gradini tra bar e botteghe, poi la grande grotta tra pareti a picco, acqua turchese, surfisti. Esplorazione con calma 1h–1h15. Bassa marea stimata ~14:00 (verificare sull'app).", en: "A ~100-step stairway past bars and stalls, then the great cave between sheer walls, turquoise water, surfers. Unhurried exploring 1h–1h15. Estimated low tide ~14:00 (verify on a tide app).", zh: "约100级台阶穿过酒吧和小店，然后进入峭壁间的大洞穴，碧绿海水，冲浪者穿梭。从容探索1–1.25小时。预计低潮约14:00（请用潮汐App核实）。" }, places: [P("Suluban Beach", "Suluban Beach Uluwatu")] },
...
// ---------------------------------------------------------- DAY 10
{
  ...
  timeline: [
    ...
    { t: "19:35", icon: "🔄", grp: "fly", title: { it: "Scalo a Kuala Lumpur (KUL · T1)", en: "Layover in Kuala Lumpur (KUL · T1)", zh: "吉隆坡转机 (KUL · T1)" },
...
const INFO = {
  it: {
    ...
    practical: [
      "Meteo: fine luglio = stagione secca (sole, sere fresche).",
  ...
  en: {
    ...
    practical: [
      "Weather: late July = dry season (sun, cool evenings).",
